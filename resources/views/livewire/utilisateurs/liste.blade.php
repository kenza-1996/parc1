          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header bg-gradient-orange d-flex align-items-center">
                ...
                <a class="btn btn-link text-white mr-4 d-block bg-black" wire:click.prevent="goToAddUser()"><i class="fas fa-user-plus"></i> Nouvel utilisateur</a>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="text-center">
                        <button class="btn btn-link bg-orange " wire:click="goToEditUser({{$user->id}})"> <i class="far fa-edit "></i> </button>
                        <button class="btn btn-link bg-orange" wire:click="confirmDelete('{{ $user->prenom }} {{ $user->nom }}', {{$user->id}})"> <i class="far fa-trash-alt"></i> </button>
                      </td>
                    </tr>
                    @endforeach
                  </tbody>
